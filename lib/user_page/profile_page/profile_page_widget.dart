              ...
              children: [
                ...
                StreamBuilder<List<ExperienceRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ExperienceRecord> columnExperienceRecordList =
                        snapshot.data!;
                    return Column(
                      mainAxisSize: MainAxisSize.max,
                      children: List.generate(columnExperienceRecordList.length,
                          (columnIndex) {
                        final columnExperienceRecord =
                            columnExperienceRecordList[columnIndex];
                        return Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Material(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          columnExperienceRecord.companyAddress,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                fontFamily:
